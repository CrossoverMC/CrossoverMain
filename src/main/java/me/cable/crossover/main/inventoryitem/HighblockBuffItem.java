...
public class HighblockBuffItem extends InventoryItem {

    public HighblockBuffItem() {
        super("highblock_buff");
    }

    @Override
    public @NotNull ItemStack createItem(@NotNull Player player) {
        return new ItemBuilder()
                .config(ConfigHandler.settings().csnn(ConfigHandler.PATH_INVENTORY_ITEMS + ".highblock-buff"))
                .create();
    }
