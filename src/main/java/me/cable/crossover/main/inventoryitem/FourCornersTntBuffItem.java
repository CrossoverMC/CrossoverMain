...
public class FourCornersTntBuffItem extends InventoryItem {

    public FourCornersTntBuffItem() {
        super("four_corners_tnt_buff");
    }

    @Override
    public @NotNull ItemStack createItem(@NotNull Player player) {
        return new ItemBuilder()
                .config(ConfigHandler.settings().csnn(ConfigHandler.PATH_INVENTORY_ITEMS + ".four-corners-tnt-buff"))
                .create();
    }
